...
function stoff_enqueue() {
  ...
  wp_enqueue_style( 'style', get_template_directory_uri() . '/assets/css/stoff.css', array (), 2.6 );
  wp_enqueue_script( 'script', get_template_directory_uri() . '/assets/js/script.js', array (), 1.5, true);
}
